...
//    @JsonSerialize(using = BigDecimalRoundingSerializer.class)
	...
	public String getDepositOperateName() {
		return depositOperateName;
	}
	public void setDepositOperateName(String depositOperateName) {
		this.depositOperateName = depositOperateName;
	}
