...
var memAccCha = new Vue({
    ...
    methods: {
        ...
        getTitleMsg: function () {
            var _this = this,
                obj = {
                    type: "post",
                    data: {},
                    url: "/bets/getRecentlyCoinUpdateCensus",
        ...
        getCoinOperateType: function () {
            let _this = this,
                obj = {
                    type: 'get',
                    url: "/coinLog/getCoinOperateType",
                    data: {},
                    success: function (data) {
                        if (data.code == 200) {
                            _this.OperateType = data.body;
                ...
                success: function success(data) {
                    ...
                    if (data.body.list == null || data.body.list == "") {
                        ...
                        for (var i = 0; i < data.body.list.length; i++) {
                            ...
                            html += '<tr><td>' + (obj.id ? obj.id : "-") + '</td><td>' + (obj.userName ? obj.userName : "-") + '</td><td>' + (obj.CoinOperateName ? obj.CoinOperateName : "-") + '</td><td>' + (obj.coinBefore ? obj.coinBefore : "0.00") + '</td><td>' + (obj.coin ? obj.coin : "0.00") + '</td><td>' + (obj.userCoin ? obj.userCoin : "0.00") + '</td><td>' + (obj.inputTime ? obj.inputTime : "-") + '</td><td>' + (obj.orderId ? obj.orderId : "-") + '</td><td>' + (obj.operateUser ? obj.operateUser : "-") + '</td><td>' + (obj.info ? obj.info : "-") + '</td></tr>';
                        }
                    }
